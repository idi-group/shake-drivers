CFLAGS="-fPIC -fno-stack-protector -Wno-write-strings -arch i386 -mmacosx-version-min=10.5 -isysroot /Developer/SDKs/MacOSX10.5.sdk -Iinc -I/Library/Frameworks/Python.framework/Versions/2.5/include/python2.5 -I/Library/Frameworks/Python.framework/Versions/2.5/include/python2.6 -F/Library/Frameworks -framework Python"
LDFLAGS="-lm -lpthread"
CPP="/usr/bin/g++"
